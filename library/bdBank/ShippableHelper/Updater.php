...
// updated by DevHelper_Helper_ShippableHelper at 2017-12-11T10:47:47+00:00

/**
 * Class bdBank_ShippableHelper_Updater
 * @version 8
...
class bdBank_ShippableHelper_Updater
{
    ...
    public static function onInitDependencies(
        ...
        $GLOBALS[self::KEY]['version'][$apiUrl][self::$_version]
            = 'bdBank_ShippableHelper_UpdaterCore';
    ...
    public static function onUninstall($apiUrl = null, $addOnId = null)
    {
        ...
        if (empty($activeAddOnIds)) {
            ...
            bdBank_ShippableHelper_UpdaterCore::_uninstallSelf($apiUrl);
        }
    }
